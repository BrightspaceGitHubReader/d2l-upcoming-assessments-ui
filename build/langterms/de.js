...
window.D2L.UpcomingAssessments.LangDeBehavior = {
	'de': {
		...
		"noAssessmentsInThisTimeFrame": "{userName} haben in diesem Zeitraum keine fälligen Übungen.",
		"noUpcomingAssessments": "{userName} haben in den nächsten zwei Wochen keine fälligen Übungen.",
		"quiz": "Test",
		"today": "Heute",
		"tomorrow": "Morgen",
